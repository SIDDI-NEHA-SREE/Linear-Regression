...
# Page Config
st.set_page_config(page_title="LR", layout="centered")
...
bill_scaled = scaler.transform(np.array([[bill]]))
tip_pred = model.predict(bill_scaled)[0]

st.markdown(
    f'<div class="prediction-box">Predicted Tip: ${tip_pred:.2f}</div>',
    unsafe_allow_html=True
)
